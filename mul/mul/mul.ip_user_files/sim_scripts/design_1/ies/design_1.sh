...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../mul.srcs/sources_1/bd/design_1/ipshared/b65a" \
       +incdir+"$ref_dir/../../../../mul.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../mul.srcs/sources_1/bd/design_1/ipshared/b65a" \
       +incdir+"../../../../mul.srcs/sources_1/bd/design_1/ipshared/ec67/hdl"
}
