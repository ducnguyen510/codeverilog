...
HD_PWD='C:/Users/ducnv/Desktop/add/add/add_fp.runs/design_1_myaddfp_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myaddfp_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myaddfp_0_0.tcl
